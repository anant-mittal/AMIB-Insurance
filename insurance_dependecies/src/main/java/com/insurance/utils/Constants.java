...
public class Constants
{
	...
	public static final List<List<Object>> emptyListOfList = Collections.unmodifiableList(new ArrayList<List<Object>>());

	/** The Constant emptyListOfListOfList. */
	public static final List<List<List<Object>>> emptyListOfListOfList = Collections.unmodifiableList(new ArrayList<List<List<Object>>>());
