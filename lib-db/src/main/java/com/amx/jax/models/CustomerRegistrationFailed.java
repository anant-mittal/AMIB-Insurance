...
public class CustomerRegistrationFailed
{
	private String regFailedType;
	...
	public String getRegFailedType()
	{
		return regFailedType;
	}

	public void setRegFailedType(String regFailedType)
	{
		this.regFailedType = regFailedType;
	}
