...
public class ActivePolicyModel {
	...
	@ApiMockModelProperty(example = "", value = "email Id")
	private String emailId;

	@ApiMockModelProperty(example = "", value = "claim contact name")
	private String claimContactName;

	@ApiMockModelProperty(example = "", value = "claim  email id")
	private List<String> claimEmailId;

	@ApiMockModelProperty(example = "", value = "claim contact no")
	private List<String> claimContactNo;
	...
	public List<String> getClaimContactNo() {
		return claimContactNo;
	}

	public void setClaimContactNo(List<String> claimContactNo) {
		this.claimContactNo = claimContactNo;
	}

	public List<String> getClaimEmailId() {
		return claimEmailId;
	}

	public void setClaimEmailId(List<String> claimEmailId) {
