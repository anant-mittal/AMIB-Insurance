...
public class PaymentReceipt
{
	...
	private BigDecimal endorsementFees;
	...
	public BigDecimal getEndorsementFees() {
		return endorsementFees;
	}

	public void setEndorsementFees(BigDecimal endorsementFees) {
		this.endorsementFees = endorsementFees;
	}
