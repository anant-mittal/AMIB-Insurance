...
public class PayMentController
{
	...
	//public AmxApiResponse<Object, Object> createApplication(@RequestHeader(value = "mOtp", required = false) String mOtpHeader, @RequestParam(required = false) String mOtp, @RequestBody Object req, HttpServletRequest request)
	...
	public AmxApiResponse<PaymentResponseDto, Object> onPaymentCallback(@RequestBody PaymentResponseDto paymentResponse)
	{
