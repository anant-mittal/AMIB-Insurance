...
public class WebAppStatus extends IStatusCodeListPlugin<WebAppStatusCodes, ApiWebAppStatus> {
	...
	public static enum WebAppStatusCodes implements IExceptionEnum {
		...
		CIVIL_ID_VALID, CIVIL_ID_INVALID, CIVIL_ID_EXPIRED, INVLD_LOGIN_CATG, INVALID_USR , INVALID_USR_PWD ,

		CIVIL_ID_ALREADY_REGISTERED, CIVIL_ID_NOT_REGESTERED, REGISTER_FAILED,

		MOBILE_NUMBER_REGISTERED, MOBILE_NUMBER_NOT_REGISTERED, INVALID_MOBILE,

		EMAIL_ID_VALID, EMAIL_ID_INVALID,

		EMAIL_ID_REGESTERED, EMAIL_ID_NOT_REGESTERED, CUSTOMER_MOBILE_EMAIL_NOT_VALIDATED ,

		EMPTY_PASSWORD, CP_OTP_NOT_GENERATED, EMPTY_CIVIL_ID ,

		MOBILE_OR_EMAIL_ALREADY_EXISTS,

		USER_OTP_ENABLED, USER_OTP_DISABLED,

		NO_QUOTE_AVAILABLE, LIST_POP_ERROR, MANDATORY_FIELDS_MISSING ,
