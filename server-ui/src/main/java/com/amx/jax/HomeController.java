...
public class HomeController {
	...
	public String getVersion() {
		 ...
		 * JsonUtil.toMap(restService.ajax(webConfig.getCdnURL() + "/dist/build.json?_="
		 * + checkTimeNew).get().asObject()); if (map.containsKey("version")) {
		 * versionNew = ArgUtil.parseAsString(map.get("version")); } checkTime =
		 * checkTimeNew; } catch (Exception e) { LOGGER.error("getVersion Exception",
		 * e); } } return versionNew;
		 */
